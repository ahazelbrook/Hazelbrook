---
title: "Why patronage forecasts miss high"
...
## Forecasts miss high, and they keep missing high
...
An untolled road forecast asks where people will drive. A tolled road forecast asks something much harder: what people will pay to save time. That question is answered with a value of travel time savings — the same parameter that, in most road appraisals, generates the largest single category of measured benefit ([ATAP T2, Cost Benefit Analysis](https://www.atap.gov.au/sites/default/files/documents/ATAP-T2-CBA-FINAL-2022-04-26.pdf)).

So one parameter does two jobs. It sets how much the project is worth, and it sets how many drivers divert onto it. Overstate it and both numbers move the same way at once, which is why demand error and benefit error are never independent.

Worse, the parameter is usually estimated by asking people what they would pay for a road that does not exist yet, on a network they have not experienced, against a free alternative they use every day. Stated preference is a legitimate technique and there is no better one available before opening. But it measures intention, and intention is generous. A toll road competes with a route that costs nothing, so a modest overstatement of willingness to pay moves a large block of trips — the demand curve is steep exactly where the forecast has to sit on it.

## Ramp-up is an assumption, not an observation

New roads take time to fill. Habits are sticky, signage is unfamiliar, and account take-up lags. Forecasters encode this as a ramp-up curve: opening traffic at some fraction of mature demand, climbing to steady state over two or three years.

The curve is where an uncomfortable opening number goes to be forgiven rather than corrected. If the first year disappoints, ramp-up explains it; if the second year disappoints, ramp-up explains that too. The evidence says otherwise. If the shortfall were genuinely a start-up effect, the actual-to-forecast ratio would climb toward 1.0 as the asset matured. It does not — it moves from roughly 0.77 to roughly 0.79 and stops. The mature demand was overstated as well; ramp-up was simply the part of the error that had a story attached.
...
That is the general lesson, and it is not hindsight: **a demand forecast is a forecast of a system, and every part of the system held by somebody else is an assumption, not an input.** Anyone building the same case today faces the same problem. The discipline is to separate what the forecaster controls from what a council, a minister or an adjacent project controls, and to price the second category as the risk it is.

## Optimism bias is published guidance, not an accusation

None of this is a claim about anybody's honesty. Optimism bias is a named, documented phenomenon in the appraisal guidance that Australian agencies write for themselves — [ATAP publishes a guidance module on it](https://www.atap.gov.au/sites/default/files/o2-optimsim-bias.pdf), and Infrastructure Australia's [Assessment Framework](https://www.infrastructureaustralia.gov.au/publications/assessment-framework) requires sensitivity testing of the inputs that carry the result.
...
None of these need a model, and none of them require you to be a modeller. They are the questions that make a forecast legible.

1. **Show me the demand curve, not the point.** Traffic at zero toll, at the assumed toll, and at 25% above it. If the first two are close together, the toll is not doing the work you think it is. If they are far apart, the entire case rests on the willingness-to-pay parameter.
2. **Where did the value of travel time come from?** A stated preference survey, a borrowed parameter, or the guidance default? When was the survey run, on what sample, and what alternative were respondents offered?
3. **What is in the reference case network?** Which competing or complementary projects are assumed built, and by when? A forecast that assumes a parallel upgrade never proceeds is making a policy prediction, not a transport one.
4. **Which assumptions belong to someone else?** List every element the project cannot control — surface road changes, parking policy, a connecting stage, a rezoning. That list is the real risk register.
5. **What ramp-up is assumed, and what happens without it?** Ask for the case where steady-state demand is 80% of assumed and the ramp is a year longer.
